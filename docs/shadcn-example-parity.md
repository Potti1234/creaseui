...
Current: 26 done · 35 todo · 3 crease-only
...
| `item` | 3 | Variant<br>Size<br>Icon<br>Avatar<br>Image<br>Group<br>Header<br>Link<br>Dropdown<br>RTL | todo (missing: Variant, Size, Icon, Avatar, Image, Group, Header, Link, Dropdown, RTL) |
...
| `progress` | 3 | Label<br>Controlled<br>RTL | todo (missing: Label, Controlled, RTL) |
...
| `separator` | 2 | Vertical<br>Menu<br>List<br>RTL | todo (missing: Menu, List, RTL) |
| `sheet` | 4 | Side<br>No Close Button<br>RTL | todo (missing: Side, No Close Button, RTL) |
| `sidebar` | 12 | — | crease-only |
| `skeleton` | 2 | Avatar<br>Card<br>Text<br>Form<br>Table<br>RTL | todo (missing: Avatar, Text, Form, Table, RTL) |
...
| `toast` | 1 | — | crease-only |
| `toggle` | 4 | Outline<br>With Text<br>Size<br>Disabled<br>RTL | todo (missing: With Text, Size, RTL) |
| `toggle-group` | 5 | Outline<br>Size<br>Spacing<br>Vertical<br>Disabled<br>Custom<br>RTL | todo (missing: Outline, Size, Spacing, Vertical, Disabled, Custom) |
| `tooltip` | 3 | Side<br>With Keyboard Shortcut<br>Disabled Button<br>RTL | todo (missing: Side, With Keyboard Shortcut, Disabled Button, RTL) |
