...
const styles = stylex.create({
  ...
  stackTight: { display: 'grid', width: '100%', maxWidth: '24rem', gap: '1rem' },
  stackWide: { display: 'grid', width: '100%', maxWidth: '28rem', gap: '1rem' },
  stackLoose: { display: 'grid', width: '100%', maxWidth: '24rem', gap: '2.5rem' },
