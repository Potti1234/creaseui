...
const styles = stylex.create({ frame: { borderColor: 'var(--border)', borderRadius: '0.375rem', borderStyle: 'solid', borderWidth: 1, overflow: 'hidden', position: 'relative', height: '18rem', maxWidth: '28rem', width: '100%', } });
