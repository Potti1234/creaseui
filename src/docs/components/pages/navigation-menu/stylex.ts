...
const content = <Msg>(h: HtmlBuilder<Msg>) => h.ul([h.Class(stylex.props(styles.content).className ?? '')], [h.li([], [h.a([h.Href('#'), h.Class(stylex.props(styles.contentLink).className ?? '')], ['Analytics'])]), h.li([], [h.a([h.Href('#'), h.Class(stylex.props(styles.contentLink).className ?? '')], ['Reports'])])]);
