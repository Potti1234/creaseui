...
import { progressTailwindPreviewProgram } from '@/docs/components/pages/progress/tailwind';

export const progressPage = authoredPage({
  slug: 'progress',
  title: 'Progress',
  kind: 'helper',
  previewProgram: progressTailwindPreviewProgram,
  definition: {
    kind: 'helper',
    ...
    examples: progressExamples('tailwind'),
