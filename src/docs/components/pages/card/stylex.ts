...
const styles = stylex.create({
  ...
  loginWrap: { gap: '1rem', marginInline: 'auto', display: 'grid', justifyItems: 'center', maxWidth: '24rem', width: '100%', },
  fieldGrid: { gap: '0.5rem', display: 'grid', },
  ...
  edgeFooterInner: { gap: '0.5rem', display: 'flex', justifyContent: 'flex-end', width: '100%', },
  imageWrap: { marginInline: 'auto', position: 'relative', maxWidth: '24rem', width: '100%', },
  overlay: {
    inset: 0,
    aspectRatio: '16 / 9',
