...
export const componentApi: Readonly<Record<string, ReadonlyArray<ApiEntry>>> = {
  ...
  "tabs": [
    ...
    },
    {
      "name": "OutMessage",
      "kind": "type",
      "signature": "OutMessage = TabsPrimitive.OutMessage<string>"
    },
    {
      "name": "init",
      "kind": "value",
    ...
    },
    {
      "name": "TabConfig",
      "kind": "type",
      "signature": "TabConfig = Readonly<{ value: string; label: Html | string; content: Html | string; isDisabled?: boolean; }>"
    },
    {
      "name": "TabsProps",
      "kind": "type",
      "signature": "TabsProps<Msg> = Readonly<{ model: Model; selectedValue: string; toParentMessage: (message: Message) => Msg; tabs: ReadonlyArray<TabConfig>; ariaLabel?: string; orientation?: TabsOrientation; activationMode?: TabsPrimitive.ActivationMode; variant?: TabsListVa…"
    },
    {
      "name": "tabs",
      "kind": "function",
      "signature": "tabs<Msg>(props: TabsProps<Msg>, h: HtmlBuilder<Msg>): Html"
    }
  ],
  "textarea": [
    {
