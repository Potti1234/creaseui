      ...
      ...(props.filterText === undefined
        ...
        : [
            h.input([
              ...
              h.Class(
                'h-8 w-full max-w-sm rounded-md border border-input bg-transparent px-2.5 text-sm shadow-xs outline-none focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50',
              ),
            ]),
          ]),
      h.div(
                ...
                visible.length === 0
                  ? [
                      h.tr(
                        ...
                        [
                          h.td(
                            [
                              h.Colspan(props.columns.length),
                  ...
                  : visible.map((row) =>
                      h.tr(
                        ...
                        props.columns.map((column) =>
                          h.td(
                            [h.Class(cn('p-2 align-middle', column.class))],
                            [column.cell(row)],
                          ),
                        ),
                      ),
            ...
            [
              h.button(
                [
                  ...
                  h.Class(
                    'h-8 rounded-md border px-3 text-sm font-medium disabled:pointer-events-none disabled:opacity-50',
                  ),
                ],
                ['Previous'],
              ),
