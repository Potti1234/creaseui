...
export const item = <Msg>(props: ItemProps): Html => {
  const h = html<Msg>()
...
export const itemMedia = <Msg>(props: ItemMediaProps): Html => {
  const h = html<Msg>()
  const variant = props.variant ?? 'default'
...
export const itemDescription = <Msg>(props: SlotProps): Html => {
  const h = html<Msg>()
...
export const itemActions = slotDiv(
  'item-actions',
...
export const itemGroup = <Msg>(props: SlotProps): Html => {
  const h = html<Msg>()
...
export const itemSeparator = <Msg>(props: ItemSeparatorProps = {}): Html => {
  const h = html<Msg>()
