...
export const view = (model: Model): Html => {
  ...
  return chartsPageShell<Message>('pie', [
    PieSimple.view(toMessage),
    PieSeparatorNone.view(toMessage),
    PieLabel.view(toMessage),
    PieLabelCustom.view(toMessage),
    PieLabelList.view(toMessage),
    PieLegend.view(toMessage),
    PieDonut.view(toMessage),
    PieDonutActive.view(toMessage),
    PieDonutText.view(toMessage),
    PieStacked.view(toMessage),
    PieInteractive.view({
