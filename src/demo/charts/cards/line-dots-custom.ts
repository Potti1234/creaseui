    ...
    series: [
      {
        ...
        smooth: 0.4,
        showSymbol: true,
        // PORT NOTE: ECharts cannot render a foldkit/Lucide Html node as a
        // point, so GitCommitVertical is approximated with an equivalent
        // compact vertical-commit vector path.
        symbol:
          'path://M10 0h4v7.1a5 5 0 1 1-4 0V0zm2 9a3 3 0 1 0 0 6 3 3 0 0 0 0-6zm-2 8h4v7h-4z',
        symbolSize: 24,
...
export const view = <Msg>(
  ...
  return card({
    children: [
      cardHeader({
        children: [
          cardTitle({ children: ['Line Chart - Custom Dots'] }),
      ...
      cardContent({
        children: [
          Chart.chart({
            hostId: HOST_ID,
            ariaLabel: 'Line chart with custom dots showing desktop visitors from January to June 2024',
            toMessage,
          }),
        ],
      }),
