...
/* Usage:
   ...
   - On selection, update that field and return
     Chart.SyncChart({ hostId: HOST_ID, variant: activeChart }), lifted through
     the parent's GotChartMessage constructor.
   - Render `view({ activeChart, onSelect, toMessage })`. */
