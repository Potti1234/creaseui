...
const HOST_ID = 'chart-area-legend';
  ...
  return card(
    {
      children: [
        cardHeader(
          {
            children: [
              cardTitle({ children: ['Area Chart - Legend'] }, h),
              cardDescription(
                {
              ...
              Chart.chart(
                {
                  hostId: HOST_ID,
                  ariaLabel:
                    'Area chart with a legend showing desktop and mobile visitors for the last 6 months',
                  toMessage,
                },
                h,
              ),
