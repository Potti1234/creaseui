...
export const view = (model: Model, blockId: string): Html => {
  ...
  return M.value(blockId).pipe(
    withHtml,
    M.when('01', () => embed('01', model.b01, v01, message => GotB01({ message }))),
    M.when('02', () => embed('02', model.b02, v02, message => GotB02({ message }))),
    M.when('03', () => embed('03', model.b03, v03, message => GotB03({ message }))),
    M.when('04', () => embed('04', model.b04, v04, message => GotB04({ message }))),
    M.when('05', () => embed('05', model.b05, v05, message => GotB05({ message }))),
    M.when('06', () => embed('06', model.b06, v06, message => GotB06({ message }))),
    M.when('07', () => embed('07', model.b07, v07, message => GotB07({ message }))),
    M.when('08', () => embed('08', model.b08, v08, message => GotB08({ message }))),
    M.when('09', () => embed('09', model.b09, v09, message => GotB09({ message }))),
    M.when('10', () => embed('10', model.b10, v10, message => GotB10({ message }))),
    M.when('11', () => embed('11', model.b11, v11, message => GotB11({ message }))),
    M.when('12', () => embed('12', model.b12, v12, message => GotB12({ message }))),
    M.when('13', () => embed('13', model.b13, v13, message => GotB13({ message }))),
    M.when('14', () => embed('14', model.b14, v14, message => GotB14({ message }))),
    M.when('15', () => embed('15', model.b15, v15, message => GotB15({ message }))),
    M.when('16', () => embed('16', model.b16, v16, message => GotB16({ message }))),
    M.orElse(() =>
      h.div(
        [h.Class('flex min-h-svh items-center justify-center text-sm text-muted-foreground')],
