...
const socialField = (props: SocialFieldProps): Html =>
  field({
    children: [
      fieldLabel({ for: props.id, children: [props.label] }),
      inputGroup({
        children: [
          inputGroupAddon({
            children: [Icon.icon<Message>(props.icon)],
          }),
          inputGroupInput({
            id: props.id,
            value: props.value,
...
export const view = (model: Model): Html =>
  card({
    children: [
      cardHeader({
        children: [cardTitle({ children: ['Social Links'] })],
      }),
      cardContent({
        children: [
          fieldGroup({
      ...
      cardFooter({
        ...
        children: [
          button({ variant: 'secondary', children: ['Discard'] }),
