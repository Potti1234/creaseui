...
const qrCells = [
  0, 1, 2, 5, 6, 7, 8, 10, 13, 15, 16, 18, 19, 21, 23, 24, 29, 31,
  32, 33, 34, 37, 38, 39, 41, 43, 44, 46, 48, 50, 53, 55, 56, 58,
  61, 62, 63,
]
            ...
            [
              ...
              h.div(
                [
                  ...
                  h.Class(
                    'grid size-40 grid-cols-8 gap-1 bg-white p-2',
                  ),
                ],
                Array.from({ length: 64 }, (_, index) =>
                  h.div(
                    [
                      h.Class(
                        qrCells.includes(index) ? 'bg-foreground' : 'bg-muted',
                      ),
                    ],
                    [],
                  ),
