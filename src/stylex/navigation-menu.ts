...
const styles = stylex.create({
  ...
  disclosureIcon: { position: 'relative', transitionDuration: interactionTokens.motionModerate, transitionProperty: 'transform', height: '0.75rem', top: 1, width: '0.75rem', },
...
export const navigationMenu = <Msg>(props: Slot & Readonly<{ ariaLabel?: string }>, h: HtmlBuilder<Msg>): Html =>
  h.nav([h.DataAttribute('slot', 'navigation-menu'), h.AriaLabel(props.ariaLabel ?? 'Main'), h.Class(className(styles.nav, props.layoutStyle))], [...props.children])

export const navigationMenuList = <Msg>(props: Slot, h: HtmlBuilder<Msg>): Html => h.ul([h.DataAttribute('slot', 'navigation-menu-list'), h.Class(className(styles.list, props.layoutStyle))], [...props.children])
...
export const navigationMenuDisclosure = <Msg>(props: NavigationMenuDisclosureProps<Msg>, h: HtmlBuilder<Msg>): Html => Popover.popover({
  ...
  trigger: h.span([h.Class(className(styles.link, styles.trigger, props.layoutStyle)), h.AriaLabel(props.ariaLabel ?? props.label)], [
    props.label,
