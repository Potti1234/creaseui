...
export const errorSummary=<Msg>(p:ErrorSummaryProps<Msg>,h:HtmlBuilder<Msg>):Html=>renderErrorSummary(p,{root:[h.Class(className(styles.summary,p.layoutStyle))],title:[h.Class(className(styles.summaryTitle))],list:[h.Class(className(styles.summaryList))],link:[h.Class(className(styles.summaryLink))]},h)
