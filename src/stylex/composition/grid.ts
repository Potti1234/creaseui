...
export type GridProps = Readonly<{
  ...
  columns?: 'one' | 'two' | 'four' | 'sidebar' | 'sidebarWide' | 'appShell' | 'appShellWide' | 'masterDetail' | 'loginSplit' | 'createBoard'
  data?: PrimitiveData
