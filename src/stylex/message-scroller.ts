...
export const messageScrollerItem = <Msg>(props: ChildrenProps & Readonly<{ scrollAnchor?: boolean; messageId?: string }>, h: HtmlBuilder<Msg>): Html => h.div([h.DataAttribute('slot', 'message-scroller-item'), ...(props.scrollAnchor === true ? [h.DataAttribute('scroll-anchor', '')] : []), ...(props.messageId === undefined ? [] : [h.DataAttribute('message-id', props.messageId)]), h.Class(className(styles.item, props.layoutStyle))], [...props.children])
